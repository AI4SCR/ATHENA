...
def test_empty_labels(so_object):
    # This tests whether passing the labels variable as an empty list returns and error
...
def test_incongruent_labels_in_labels(so_object):
    # This tests whether passing labels that are not 'filter_col' returns and error
    config = get_default_config(
        builder_type='knn',
        build_concept_graph=True
    )
...
def test_name(so_object):
    # this testes whether the name gets assigned
    config = get_default_config(
        builder_type='contact',
        build_concept_graph=True
    )
